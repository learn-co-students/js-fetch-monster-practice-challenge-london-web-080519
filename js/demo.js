...
// function get(page, direction){
    
//     if (direction === 'start'){
//       return fetch(`http://localhost:3000/monsters/?_limit=50&_page=3`).then(response => {
//          //console.log(response.url.split('=')[2]);
//          let currentPage = response.url.split('=')[2]
//          console.log(page)
//         return response.json()})
//     }else if (direction === 'forward'){
     
//      return fetch(`http://localhost:3000/monsters/?_limit=50&_page=${currentPage ++}`).then(response => {
//         //console.log(response.url.split('=')[2]);
//         currentPage = response.url.split('=')[2]
//         console.log(page)
//        return response.json()})
//     }
